...
$sourcePath = "C:\MyBlogs\MyBlogs\BlogPosts"
$destinationPath = "C:\Users\Susan\OneDrive\Documents\susanblog\content\posts"

# Set Github repo 
$myrepo = "git@github.com:susan-labs/blogs.git"
